...
The goal of DyAlloc is to provide clinical trial group allocation for a new subject entering the study. Imbalance scores for each possible treatment group for the new subject are calculated given all the profiles from the previous subjects, along with the treatment allocation probability for each group. 

## Installation

You can install the released version of DyAlloc from [CRAN](https://CRAN.R-project.org) with:
